 ...
 * **Say-Can**: "Do As I Can, Not As I Say: Grounding Language in Robotic Affordances", *arXiv, Apr 2021*. [[Paper](https://arxiv.org/abs/2204.01691)] [[Website](https://say-can.github.io/)]
 ...
 * **LM-Nav**: "Inner Monologue: Embodied Reasoning through Planning with Language Models", *arXiv, July 2022*. [[Paper](https://arxiv.org/abs/2207.04429)] [[Website](https://sites.google.com/view/lmnav)]
 ...
 * **ZSP**: "Language Models as Zero-Shot Planners: Extracting Actionable Knowledge for Embodied Agents", *arXiv, Jan 2022*. [[Paper](https://arxiv.org/abs/2201.07207)] [[Pytorch Code](https://github.com/cliport/cliport)] [[Website](https://wenlong.page/language-planner/)]
 ...
 * **ZeST**: "Can Foundation Models Perform Zero-Shot Task Specification For Robot Manipulation?", *arXiv, Apr 2022*. [[Paper](https://arxiv.org/abs/2204.11134)]
 ...
 * **CLIPort**: "CLIPort: What and Where Pathways for Robotic Manipulation", *arXiv, Sept 2021*. [[Paper](https://arxiv.org/abs/2109.12098)] [[Pytorch Code](https://github.com/huangwl18/language-planner)] [[Website](https://cliport.github.io/)]

---
## Instructions and Navigation

 * **ADAPT**: "ADAPT: Vision-Language Navigation with Modality-Aligned Action Prompts", *arXiv, CVPR 2022*. [[Paper](https://arxiv.org/abs/2205.15509)] [[Pytorch Code](https://github.com/sparisi/pvr_habitat)] [[Website](https://sites.google.com/view/pvr-control)]
